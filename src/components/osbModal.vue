      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header d-flex justify-content-between">
            <h5 class="modal-title" id="awsModalLabel">Operating Systems Basics</h5>
            <div class="btn-close-modal" data-bs-dismiss="modal" aria-label="Close"></div>
          </div>
          <div class="modal-body">
            <div class="aws-certificates" v-if="badgeInfo">
                <div class="certificate-content">
                  <img :src="badgeInfo[0].badge" alt="badge" loading="eager">
                  <ButtonEffect 
                  label="View certificate" 
                  :href="badgeInfo[0].certificate" target="_blank" class="btn-view-cert"
                />
            </div>
