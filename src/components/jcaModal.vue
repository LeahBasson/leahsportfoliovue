<template>
    <div class="modal fade" id="jcaModal" tabindex="-1" aria-labelledby="awsModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header d-flex justify-content-between">
            <h5 class="modal-title" id="awsModalLabel">Junior Cybersecurity Analyst</h5>
            <div class="btn-close-modal" data-bs-dismiss="modal" aria-label="Close"></div>
          </div>
          <div class="modal-body">
            <div class="aws-certificates" v-if="badgeInfo">
                <div class="certificate-content">
                  <img :src="badgeInfo[2].badge" alt="badge" loading="eager">
                  <ButtonEffect 
                  label="View certificate" 
                  :href="badgeInfo[2].certificate" target="_blank" class="btn-view-cert"
                />
            </div>
