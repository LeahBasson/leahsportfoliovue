<template>
    <div class="modal fade" id="scrumModal" tabindex="-1" aria-labelledby="awsModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header d-flex justify-content-between">
            <h5 class="modal-title" id="awsModalLabel">Scrum Hackathon</h5>
            <div class="btn-close-modal" data-bs-dismiss="modal" aria-label="Close"></div>
          </div>
          <div class="modal-body">
            <div class="aws-certificates" v-if="caseStudies">
                <div class="certificate-content">
                  <img :src="caseStudies[1].badge" alt="badge" loading="eager">
                  <ButtonEffect 
                  label="View case study" 
                  :href="caseStudies[1].docLink" target="_blank" class="btn-view-cert"
                />
            </div>
...
<script setup>
  ...
  const caseStudies = computed(() => store.state.caseStudies)
