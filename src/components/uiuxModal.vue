<template>
    <div class="modal fade" id="uiuxModal" tabindex="-1" aria-labelledby="awsModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header d-flex justify-content-between">
            <h5 class="modal-title" id="awsModalLabel">Ui/Ux Hackathon</h5>
            <div class="btn-close-modal" data-bs-dismiss="modal" aria-label="Close"></div>
          </div>
          <div class="modal-body">
            <div class="aws-certificates" v-if="caseStudies">
                <div class="certificate-content">
                  <img :src="caseStudies[0].badge" alt="badge" loading="eager">
                  <ButtonEffect 
                  label="View case study" 
                  :href="caseStudies[0].docLink" target="_blank" class="btn-view-cert"
                />
            </div>
